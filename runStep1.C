...
void runStep1(TString file){
  ...
  TString inputFile="/uscms_data/d3/rsyarif/XCone/XConeinLJMet80x/CMSSW_8_0_17/src/LJMet/Com/condor_XConeStudy/"+file+".root";
  
  TString outputFile=file+"_step1_XCone.root";

  //TString inputtree="ljmet";
  
  gSystem->AddIncludePath("-I$CMSSW_BASE/src/");
  
  step1_XCone t(0,inputFile,outputFile);
//   step1_XCone t;
  t.Loop();
}
